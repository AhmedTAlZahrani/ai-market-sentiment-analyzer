"""Scrape FinViz news headlines and download stock price history."""
import pandas as pd
import requests
...
def fetch_finviz_news(tickers):
    ...
    for ticker in tickers:
        ...
        for row in news_table.findAll("tr"):
            ...
            time = date_data[-1]
            all_news.append([ticker, date, time, headline])
...
if __name__ == "__main__":
    ...
    news_df = fetch_finviz_news(tickers)
    price_data = fetch_stock_data(tickers, period="30d")
